...
const POINTS = [
  { text: 'Compara opciones verificadas' },
  { text: 'Agenda test drives reales' },
  { text: 'Financiamiento sin letra pequeña' },
];
            ...
            <ul className="flex flex-col gap-3">
              {POINTS.map((p) => (
                <li key={p.text} className="flex items-center gap-3">
                  ...
                  >
                    <span style={{ fontSize: 11, color: '#C8F135', fontWeight: 700 }}>✓</span>
                  </span>
